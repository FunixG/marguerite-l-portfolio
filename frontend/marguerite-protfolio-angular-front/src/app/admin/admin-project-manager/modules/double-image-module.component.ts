...
import {ImageAndImageAbsModule} from "../../../../services/projects/modules/abstract/image-and-image-abs-module";

@Directive()
export abstract class DoubleImageModuleComponent<T extends ImageAndImageAbsModule> extends ModuleComponent<T> {

    first?: ProjectMediaDto
    second?: ProjectMediaDto

    onLoadedModule(module: T): void {
